      ...
      <div class="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 -mx-4 sm:-mx-6 lg:-mx-8">
        <div class="w-full max-w-md">
          ...
          <div class="text-center mb-8">
            ...
            <p class="text-slate-400 mt-2">Join Sangrah and start sharing</p>
          </div>
          ...
          <form [formGroup]="form" (ngSubmit)="onSubmit()" class="space-y-4">
            ...
            <div>
              ...
              />
              <div *ngIf="form.get('displayName')?.invalid && form.get('displayName')?.touched" class="text-red-400 text-sm mt-1">
                Name is required
              </div>
            </div>
            ...
            <div>
              ...
              <div *ngIf="form.get('password')?.invalid && form.get('password')?.touched" class="text-red-400 text-sm mt-1">
                <span *ngIf="form.get('password')?.getError('required')">Password is required</span>
                <span *ngIf="form.get('password')?.getError('minlength')">Password must be at least 8 characters</span>
              </div>
            </div>
            ...
            <div>
              ...
              <input
                ...
                placeholder="••••••••"
              />
              <div *ngIf="form.getError('passwordMismatch') && form.get('confirmPassword')?.touched" class="text-red-400 text-sm mt-1">
